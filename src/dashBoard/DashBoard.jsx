...
const PieChartComponent = () => {
  ...
  const columns = [
    {
      ...
      className: "data1",
      render: (image) => (
        <img src={image} alt="Gambar" width={20} height={20} />
      ),
    },
    {
      dataIndex: "names",
  ...
  // const [data] = useState(INITIAL_TABLE_DATASSS);
    ...
    <div>
      ...
      <Row>
        <Col span={12} push={16} className="data2">
          <a>
            <h1 className="jarak">Data Penjualan</h1>
          </a>
        ...
        <Col span={13} pull={11} className="data3">
          <a>
            <h1 className="jarak">Data Produk</h1>
          </a>
